    ...
    <div class="sidebar">
      <div class="sidebar-content email-app-sidebar">
        <div class="email-app-menu">
          <div
            class="sidebar-menu-list sidebar-nav text-center p-1"
          ...
          >
            ...
            <p>
              We help thousands of customers sign and notarise documents the
              easy way.
            </p>
            <p>
              We continue to work hard to ensure that our notary process is
              fully automated, legally binding and affordable for all our
              customers.
            </p>
            <h4>Contact Us</h4>
            <p>
              Office Address: 1625b Saka Jojo Street, Victoria Island, Lagos.
            </p>
            ...
            <div class="list-group list-group-messages d-none">
              ...
              <div class="list-group-item list-group-item-action border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    Added Tool ({{
                      workingTools.length > 0 ? workingTools.length : 0
                    }})
                  </div>
                </div>
              </div>
              ...
              <template v-if="userDocument.is_the_owner_of_document === true">
                ...
                >
                  ...
                  <div class="avatar-group">
                    <div
                      ...
                      :data-bs-original-title="init.user.first_name"
                      :data-id="init.id"
                      :key="index"
                    >
                      <div class="avatar-content">
                        {{
                          getFirstLetters(
                            init.user.first_name + " " + init.user.last_name
                          )
                        }}
                      </div>
                    </div>
                ...
                >
                  <span class="isHover"
                    >View all signers <span>&rightarrow;</span></span
                  >
                </div>
              </template>
            </div> -->
        ...
        >
          <div class="col-md-3 col-12">
            <div class="mb-1">
              ...
              <input
                :readonly="!userDocument.is_the_owner_of_document"
                type="text"
                name="first_name"
          ...
          <div class="col-md-3 col-12">
            <div class="mb-1">
              ...
              <input
                ...
                type="email"
                name="email"
                v-model="participant.user.email"
                class="form-control form-control-sm"
              />
            </div>
          </div>
          <div class="col-md-3 col-12">
            <div class="mb-1">
              ...
              <select
                name="role"
                :disabled="!userDocument.is_the_owner_of_document"
