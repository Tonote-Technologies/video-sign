...
const DocumentPreview = () =>
  import(
    /* webpackChunkName: "edit-document" */ "@/views/documents/DocumentPreview.vue"
  );
...
const WaitingPage = () =>
  import(
    /* webpackChunkName: "auth-register" */ "@/components/Video/WaitingPage/WaitingPage.vue"
  );
const AuthVerify = () =>
  import(
    /* webpackChunkName: "auth-register" */ "@/components/Auth/AuthVerify.vue"
  );


const ScreenRecording = () =>
  import(
    /* webpackChunkName: "edit-document" */ "@/components/Document/Edit/ScreenRecording.vue"
  );

const DownloadRecording = () =>
  import(
    /* webpackChunkName: "download-recording" */ "@/components/Document/Edit/DownloadRecording.vue"
  );
...
const routes = [
...

  {
    ...
    children: [
      ...
      // waiting page
      {
        ...
        meta: {
          ...
          metaTags: [
            {
              name: "description",
              content: "The document Edit waiting page of ToNote.",
            },
            {
              property: "og:description",
              content: "The document Edit waiting page of ToNote.",
      ...
      // schedule video signing
      {
        path: "video-signing-schedule",
        name: "document.video",
        component: VideoScheduleView,
        meta: {
...

      {
        ...
        meta: {
          title: "Screen Recorder | ToNote",
          requiresAuth: true,
          metaTags: [
            {
              name: "description",
              content: "The Screen Recorder page of ToNote.",
            },
            {
              property: "og:description",
              content: "The Screen Recorder page of ToNote.",
      ...
      {
        path: "downloadrecording",
        name: "document.downloadrecording",
        component: DownloadRecording,
        meta: {
          title: "Download Recording | ToNote",
          requiresAuth: true,
          metaTags: [
            {
              name: "description",
              content: "The Download Recording page of ToNote.",
            },
            {
              property: "og:description",
              content: "The Download Recording page of ToNote.",
